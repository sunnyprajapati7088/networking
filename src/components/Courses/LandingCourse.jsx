...
//         {
//           name: "CCNA",
//           description: "Cisco Certified Network Associate (CCNA) is a foundational certification covering networking fundamentals, IP services, security basics, automation, and programmability. ",
              ...
              {vendor.courses.map((course, courseIndex) => (
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    <p className="text-gray-700 mb-6 flex-1">{course.description}</p>
